...
# [Repository Dashboard](https://pkg.robjhyndman.com/gh-dashboard/){.badge .badge-large .badge-blue}
...
### [R Universe](https://robjhyndman.r-universe.dev/){.badge .badge-large .badge-blue}
...
#| warning: false
#| message: false
packages <- rjh_packages() |> suppressMessages() |> suppressWarnings()
