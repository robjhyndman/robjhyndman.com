...
<ul class="fa-ul">
  ...
  <li><a href="https://scholar.google.co.uk/citations?user=vamErfkAAAAJ"><i class="fa-li ai ai-google-scholar" style="padding-top:4px;"></i>Google Scholar</a></li>
  <li><a href="http://en.wikipedia.org/wiki/Rob_J._Hyndman"><i class="fa-li fa-brands fa-wikipedia-w"></i>Wikipedia page</a></li>
  <li><a href="http://ideas.repec.org/e/phy3.html"><i class="fa-li fa-regular fa-lightbulb"></i>RePEc page</a></li>
  <li><a href="https://github.com/robjhyndman"><i class="fa-li fa-brands fa-github"></i>robjhyndman on GitHub</a></li>
</ul>
