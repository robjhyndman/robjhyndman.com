...
- [Introduction to LaTeX](https://web.archive.org/web/20240731051911/https://robjhyndman.com/hyndsight/latex-workshop/):  notes and other materials from a one-day workshop.
...
The first and best place to go is [TeX.StackExchange.com](http://tex.stackexchange.com).
Search for help or ask a question.
Otherwise, one of the following websites might be useful.
