...
$$
\text{MASE} = \frac{\frac{1}{n}\sum_{t} |y_t - \hat{y}_t|}{\frac{1}{T-m}\sum_{t=m+1}^T |y_t - y_{t-m}|}
$$
...
$$
\text{RMSSE} = \sqrt{\frac{\frac{1}{n}\sum_{t} (y_t - \hat{y}_t)^2}{\frac{1}{T-m}\sum_{t=m+1}^T (y_t - y_{t-m})^2}},
$$
...
$$\sqrt{\frac{1}{T-1}\sum_{t=2}^T (y_{t} - y_{t-1})^2} = \sqrt{\frac{1}{T-1}\sum_{t=2}^T (b + \varepsilon_t - \varepsilon_{t-1})^2}$$
