...
Users of previous versions of the package should read [the vignette](https://web.archive.org/web/20240226035558/https://cran.r-project.org/web/packages/hts/vignettes/hts.pdf) (pp.10-11) which explains some syntax and function changes.
