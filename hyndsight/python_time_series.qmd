...
categories:
  ...
  - anomalies
  - hts
bibliography: [/home/hyndman/git/CV/rjhpubs.bib, theta.bib]
csl: ../files/apa-single-spaced.csl
image: /img/thumbs/python.png
description: Regular readers will know that I develop statistical models and algorithms, and I write R implementations of them.
  I'm often asked if there are also Python implementations available.
  There are.
---
...
Here are some of their packages related to my work, all compatible with [`scikit-learn`](http://scikit-learn.org/).
...
[GluonTS](https://ts.gluon.ai/) from Amazon is excellent and provides lots of probabilistic time series forecasting models, with wrappers to some of my R code, and statsforecast from Nixtla.
The other models in GluonTS are also well worth exploring.

## Merlion

[Merlion](https://github.com/salesforce/Merlion) from Salesforce is another interesting python library which includes both my automatic ARIMA and automatic ETS algorithms, along with other forecasting methods.
It also has some anomaly detection methods for time series.
...
and more.
These are also compatible with [`scikit-learn`](http://scikit-learn.org/).
...
[Darts](https://unit8co.github.io/darts/) is a Python library for wrangling and forecasting time series.
It includes wrappers for ETS, ARIMA and other models from [`statsforecast`](https://nixtla.github.io/statsforecast/) and [`pmdarima`](https://alkaline-ml.com/pmdarima/), and some [reconciliation functionality](https://unit8co.github.io/darts/examples/16-hierarchical-reconciliation.html).
