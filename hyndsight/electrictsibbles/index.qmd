...
The [Global Energy Forecasting Competition in 2017](https://web.archive.org/web/20220119012907/http://www.drhongtao.com/gefcom) involved data on hourly zonal loads of ISO New England from March 2003 to April 2017. The data have already been packaged into tibble format by Cameron Roach in the [gefcom2017data Github repository](https://github.com/camroach87/gefcom2017data). So it is relatively easy to convert this to a tsibble.
