...
comments:
  giscus:
    repo:  robjhyndman/hyndsight
    repo-id: "R_kgDOH79Fnw"
    category: "Announcements"
    category-id: "DIC_kwDOH79Fn84CRPee"
    mapping: "pathname"
...
Then I needed to set up giscus on the Github repo that hosts the comments ([`robjhyndman/hyndsight`](https://github.com/robjhyndman/hyndsight)). The [instructions on the giscus website](https://giscus.app) make it very simple.
