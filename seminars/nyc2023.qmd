...
**Two-day workshop, Columbia University, New York City. 11-12 July 2023**

*To be taught by Mitch O'Hara-Wild*

<a href="https://rstats.ai/tickets.html" class="badge badge-blue">Register</a>
...
3. Would you like to learn how to use some tidy tools for time series analysis including visualization, decomposition and forecasting?

## Prework

People who don't use R regularly, or don't know the tidyverse packages, are recommended to do the tutorials at [learnr.numbat.space](https://learnr.numbat.space) beforehand.
...
[R code](https://raw.githubusercontent.com/robjhyndman/forecasting_workshop/main/labs.R) -->
